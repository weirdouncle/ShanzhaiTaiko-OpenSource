...
public class CriFsBinder : CriDisposable
{
	...
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern int CRIWARE2D74D2C7(uint id);
	...
	private static int CRIWARE2D74D2C7(uint id) { return 0; }
	#endif
...
public static class CriFsUtility
{
	...
	{
		/* User-Agent文字列を指定 */
		CRIWARED410F863(userAgentString);
	}
	...
	{
		/* プロキシ設定 */
		CRIWARE99818C19(proxyPath, proxyPort);
	}
	...
	{
		CRIWAREEF16F50B(filter);
	}

	#region DLL Import
	#if !CRIWARE_ENABLE_HEADLESS_MODE
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern bool CRIWARED410F863(string userAgentString);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern bool CRIWARE99818C19(string proxyPath, UInt16 proxyPort);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern bool CRIWAREEF16F50B(string filter);
	#else
	private static bool CRIWARED410F863(string userAgentString) { return true; }
	private static bool CRIWARE99818C19(string proxyPath, UInt16 proxyPort) { return true; }
	private static bool CRIWAREEF16F50B(string filter) {return true; }
	#endif
	#endregion
}
...
public static class CriFsPlugin
{
	...
	public static void InitializeLibrary()
	{
		...
		/* ライブラリの初期化 */
		CriFsPlugin.CRIWAREC5A1CEAB();
	}

	public static bool IsLibraryInitialized()
	{
		/* ライブラリが初期化済みかチェック */
		return CRIWARE3ACEE24A();
	}
	...
	public static void FinalizeLibrary()
	{
		...
		/* ライブラリの終了 */
		CriFsPlugin.CRIWARE90FCC3A9();
	}

	#region DLL Import
	#if !CRIWARE_ENABLE_HEADLESS_MODE
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE689CFC1D(
	...
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWAREC5A1CEAB();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern bool CRIWARE3ACEE24A();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE90FCC3A9();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern uint CRIWARE1F0FB9BF();
	...
	private static void CRIWARE689CFC1D(
		int num_loaders, int num_binders, int num_installers, int max_path, bool minimize_file_descriptor_usage, bool enable_crc_check) { }
	private static void CRIWAREC5A1CEAB() { _dummyInitialized = true; }
	public static bool CRIWARE3ACEE24A() { return _dummyInitialized; }
	private static void CRIWARE90FCC3A9() { _dummyInitialized = false; }
	public static uint CRIWARE1F0FB9BF() { return 0u; }
