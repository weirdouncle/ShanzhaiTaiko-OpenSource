...
#error unsupported platform
	...
	{
		UsedVoicesInfo info;
		CRIWARE5353B792((int)voicePoolId, out info.numUsedVoices, out info.numPoolVoices);
		return info;
	}
	...
	private static extern void CRIWARE5353B792(int voice_pool_id, out int num_used_voices, out int num_pool_voices);
	...
	#endif
	#else
	private static void CRIWARE5353B792(int voice_pool_id, out int num_used_voices, out int num_pool_voices)
...
public class CriAtomExStandardVoicePool: CriAtomExVoicePool
{
	 ...
	 * If you want to play a sound with six or more channels,
	 * create a Voice Pool using this API.<br/>
	 ...
	 * create a Voice with a specifying non-zero value as identifier, and call the CriAtomExPlayer::SetVoicePoolIdentifier function.</para>
	 * </remarks>
