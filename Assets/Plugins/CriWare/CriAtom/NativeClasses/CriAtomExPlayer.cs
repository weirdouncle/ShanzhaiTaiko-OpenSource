...
public class CriAtomExPlayer : CriDisposable
{
	...
	public override void Dispose()
	{
		...
		if (this.entryPoolHandle != IntPtr.Zero) {
			...
			CRIWARE6AFC0850(this.entryPoolHandle);
		}
	...
	public void PrepareEntryPool(int capacity, bool stopOnEmpty)
	{
		...
		this.entryPoolHandle = CRIWAREC8FAAC28(this.handle, capacity, this.max_path, stopOnEmpty);
		if (this.entryPoolHandle != IntPtr.Zero) {
	...
	public int GetNumEntries()
	{
		...
		return CRIWAREEE689E04(this.entryPoolHandle);
	}
	...
	public bool EntryFile(CriFsBinder binder, string path, bool repeat)
	{
		...
		return CRIWARE7DDABDA6(this.entryPoolHandle,
	...
	public bool EntryContentId(CriFsBinder binder, int contentId, bool repeat)
	{
		...
		return CRIWARE605CC5D9(this.entryPoolHandle,
								(binder != null) ? binder.nativeHandle : IntPtr.Zero,
								contentId,
								repeat);
	}
	...
	public bool EntryData(byte[] buffer, int size, bool repeat)
	{
		...
		return CRIWAREEA68FF0A(this.entryPoolHandle, buffer, size, repeat);
	}
	...
	public bool EntryCue(CriAtomExAcb acb, string name, bool repeat)
	{
		...
		return CRIWARE46F72CF1(this.entryPoolHandle,
	 ...
	 * the ::CriAtomExPlayer::Startfunction before the sound playback actually starts.<br/>
	...
	public void Stop(bool ignoresReleaseTime)
	{
		...
		if (this.entryPoolHandle != IntPtr.Zero) {
			CRIWARE6119A54B(this.entryPoolHandle);
		}
	}
	 ...
	 * After the AISAC is attached using this function, when the playback is started using the ::CriAtomExPlayer::Startfunction ,
	 ...
	 * <remarks>
	 * <para header='Description'>Sets the selector name and label name to the player. Up to 8 can be set for one player<br/>
	 * If a Cue with Selector Labels specified for their tracks is played, only the track that matches the Selector Label
	 * specified with this function is played.<br/>
	 * Call ::CriAtomExPlayer::ClearSelectorLabels for individually deleting the label information set in the player.<br/>
	 * Call ::CriAtomExPlayer::ResetParameters for deleting all player setting values including label information.<br/></para>
	 * </remarks>
	...
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern IntPtr CRIWAREC8FAAC28(IntPtr player, int capacity, int max_path, bool stopOnEmpty);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE6AFC0850(IntPtr pool);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern int CRIWAREEE689E04(IntPtr pool);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern bool CRIWARE7DDABDA6(IntPtr pool, IntPtr binder, string path, bool repeat, int max_path);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern bool CRIWARE605CC5D9(IntPtr pool,  IntPtr binder, int id, bool repeat);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern bool CRIWAREEA68FF0A(IntPtr pool, byte[] buffer, int size, bool repeat);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern bool CRIWAREEA68FF0A(IntPtr pool, IntPtr buffer, int size, bool repeat);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern bool CRIWARE46F72CF1(IntPtr pool, IntPtr acbhn, string name, bool repeat);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE6119A54B(IntPtr pool);
	...
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE23C7E305(IntPtr player, bool sw);
	...
	private static IntPtr CRIWAREC8FAAC28(IntPtr player, int capacity, int max_path, bool stopOnEmpty) { return new IntPtr(1); }
	private static void CRIWARE6AFC0850(IntPtr pool) { }
	private static int CRIWAREEE689E04(IntPtr pool) { return 0; }
	private static bool CRIWARE7DDABDA6(IntPtr pool, IntPtr binder, string path, bool repeat, int max_path) { return true; }
	private static bool CRIWARE605CC5D9(IntPtr pool,  IntPtr binder, int id, bool repeat) { return true; }
	private static bool CRIWAREEA68FF0A(IntPtr pool, byte[] buffer, int size, bool repeat) { return true; }
	private static bool CRIWAREEA68FF0A(IntPtr pool, IntPtr buffer, int size, bool repeat) { return true; }
	private static bool CRIWARE46F72CF1(IntPtr pool, IntPtr acbhn, string name, bool repeat) { return true; }
	private static void CRIWARE6119A54B(IntPtr pool) { }
	...
	private void CRIWARE23C7E305(IntPtr player, bool sw) { _dummyLoop = sw; }
