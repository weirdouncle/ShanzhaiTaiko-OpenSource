...
public class HeadColorScript : MonoBehaviour
{
    public virtual void SetSkin(Color color)
    {
    }

    public virtual void SetBodySkin(Color color)
    {
    }

    public virtual void SetFace(Color color)
    {
    }

    public virtual void InitEmotion(Sprite[] sprites, bool big)
    {
    }
